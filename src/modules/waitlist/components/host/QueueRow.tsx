...
import { isOverdue, rowChips, waitedText, type Chip } from '../../domain/hostQueue'
...
const PRIMARY: Partial<Record<HostAction, boolean>> = { call: true, seat: true }
 ...
 */
export function QueueRow({ row, holdMinutes, offsetMs, now, offline, busy, onAction }: QueueRowProps) {
