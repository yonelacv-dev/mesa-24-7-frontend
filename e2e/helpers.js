...
export async function joinQueue(page, { slug = SLUG, name = 'Carla', phone = uniquePhone(), partySize = 2 } = {}) {
...
export async function loginAsHost(page, { slug = SLUG, username = HOST_USERNAME, password = HOST_PASSWORD } = {}) {
